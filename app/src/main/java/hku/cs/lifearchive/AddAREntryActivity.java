    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeAnchorModelButton.setOnClickListener(new View.OnClickListener() {
                                                       ...
                                                       public void onClick(View v) {
                                                           ...
                                                           PopupMenu popupMenu = new PopupMenu(AddAREntryActivity.this, changeAnchorModelButton);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        try {
            ...
            for (int i = 0; i < virtualObject.length; ++i) {
                ...
                Log.i(TAG, objPath[i]);
                virtualObject[i].createOnGlThread(/*context=*/ AddAREntryActivity.this, objPath[i], texturePath[i]);
